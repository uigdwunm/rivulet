...
public abstract class MultiParamDefinitionManager implements ParamDefinitionManager {
    ...
    public MultiParamDefinitionManager(Parameter[] parameters, ConvertorManager convertorManager) {
