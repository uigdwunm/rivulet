...
public class LikeOperateDefinition extends OperateDefinition {

    private final SingleValueElementDefinition leftElement;

    private final SingleValueElementDefinition rightElement;

    private LikeOperateDefinition(CheckCondition checkCondition, SingleValueElementDefinition leftElement, SingleValueElementDefinition rightElement) {
    ...
    public LikeOperateDefinition(SQLParserPortableToolbox toolbox, SelectItemDefinition selectItemDefinition, Param<?> param, CheckCondition checkCondition) {
    ...
    public class Copier implements Definition.Copier {
        ...
        @Override
        public LikeOperateDefinition copy() {
            return new LikeOperateDefinition(checkCondition, leftElement, rightElement);
        }
    }
}
