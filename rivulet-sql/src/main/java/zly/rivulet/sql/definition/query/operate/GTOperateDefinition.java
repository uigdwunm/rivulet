...
public class GTOperateDefinition extends OperateDefinition {
    ...
    private GTOperateDefinition(CheckCondition checkCondition, SingleValueElementDefinition leftElement, SingleValueElementDefinition rightElement) {
    ...
    public GTOperateDefinition(SQLParserPortableToolbox toolbox, SelectItemDefinition selectItemDefinition, Param<?> param, CheckCondition checkCondition) {
    ...
    public class Copier implements Definition.Copier {
        ...
        @Override
        public GTOperateDefinition copy() {
            return new GTOperateDefinition(checkCondition, leftElement, rightElement);
        }
    }
}
