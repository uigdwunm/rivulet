...
public class NotEqOperateDefinition extends OperateDefinition {

    private final SingleValueElementDefinition leftElement;

    private final SingleValueElementDefinition rightElement;

    private NotEqOperateDefinition(CheckCondition checkCondition, SingleValueElementDefinition leftElement, SingleValueElementDefinition rightElement) {
        super(checkCondition, null);
        this.leftElement = leftElement;
        this.rightElement = rightElement;
    }

    public NotEqOperateDefinition(SQLParserPortableToolbox sqlPreParseHelper, Condition condition) {
        this(sqlPreParseHelper, (ConditionElement) condition);
    }

    public NotEqOperateDefinition(SQLParserPortableToolbox toolbox, ConditionElement condition) {
    ...
    public NotEqOperateDefinition(SQLParserPortableToolbox toolbox, SelectItemDefinition selectItemDefinition, Param<?> param, CheckCondition checkCondition) {
    ...
    public class Copier implements Definition.Copier {
        ...
        @Override
        public NotEqOperateDefinition copy() {
            return new NotEqOperateDefinition(checkCondition, leftElement, rightElement);
        }
    }
}
