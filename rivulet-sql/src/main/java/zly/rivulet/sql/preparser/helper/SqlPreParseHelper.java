...
public class SqlPreParseHelper implements PreParseHelper {
    ...
    public SQLSingleValueElementDefinition parse(SingleValueElementDesc<?, ?> singleValueElementDesc) {
        if (singleValueElementDesc instanceof FieldMapping) {
            ...
            return (SqlQueryDefinitionSQL) sqlPreParser.parse((SqlQueryMetaDesc<?, ?>) singleValueElementDesc, method);
